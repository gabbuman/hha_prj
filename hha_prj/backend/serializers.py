...
from backend.models import BiomechanicalSupport,Points
...
class DischargedAliveRehabGreenDataSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = '__all__'
class StayedInWardRehabGreenDataSerializer(serializers.ModelSerializer):
    class Meta:
        model = StayedInWardRehabGreenData
        fields = '__all__'
...
class BiomechanicalSupportSerializer(serializers.ModelSerializer):
    class Meta:
        model = BiomechanicalSupport
        fields = '__all__'
